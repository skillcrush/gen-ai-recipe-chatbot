...
def main():
    ...
    if not args.use_similarity_search and not args.use_self_query_retrieval and not args.use_multi_query and not args.use_rag_fusion and not args.use_self_query_rag_fusion and not args.use_hyde:
